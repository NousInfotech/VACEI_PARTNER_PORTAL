import { History, CheckCircle2, Clock, User, XCircle } from "lucide-react";
import { ShadowCard } from "../../../../../ui/ShadowCard";

const MOCK_HISTORY = [
    { id: 1, status: 'Rejected', date: 'Oct 25, 2024', time: '10:00', user: 'Admin Reviewer', type: 'error' },
    { id: 2, status: 'Review In Progress', date: 'Oct 24, 2024', time: '14:30', user: 'Sarah Wilson', type: 'warning' },
    { id: 3, status: 'Submitted', date: 'Oct 24, 2024', time: '09:15', user: 'Mike Chen', type: 'success' },
    { id: 4, status: 'Draft Created', date: 'Oct 23, 2024', time: '16:45', user: 'System', type: 'default' },
];

export default function TaxStatusHistoryCard() {
    return (
                        ...
                        <div className={`
                            ...
                            ${item.type === 'success' ? 'bg-green-100 text-green-600' :
                                item.type === 'warning' ? 'bg-orange-100 text-orange-600' :
                                    item.type === 'error' ? 'bg-red-100 text-red-600' : 'bg-gray-100 text-gray-500'}
                        `}>
                            {item.type === 'success' ? <CheckCircle2 size={10} /> :
                                item.type === 'error' ? <XCircle size={10} /> : <Clock size={10} />}
                        </div>
