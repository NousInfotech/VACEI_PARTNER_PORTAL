  ...
  return (
    <div className="mx-auto space-y-8 animate-in fade-in duration-500">
      {/* <div className="flex flex-col gap-4">
        <BackButton />
        <PageHeader
          title={`${serviceName} Engagement`}
          subtitle="Oversee your engagement progress, documents, and collaboration in one place."
          actions={
      ...
      {activeTab === 'dashboard' ? (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {/* Analytics Section */}
            <ShadowCard className="p-8 group relative overflow-hidden">
              ...
              <div className="flex items-center justify-between mb-8 relative z-10">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-xl font-bold text-gray-900 font-secondary">Engagement Analytics</h2>
                    <p className="text-sm text-gray-500">Overall progress and efficiency metrics</p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                    <span className="text-3xl font-bold text-primary">{MOCK_STATUS.overall}%</span>
            ...
            {/* Other Services Specific Boxes */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <ShadowCard className="p-6 border-l-4 border-l-blue-500 hover:shadow-xl transition-all duration-300">
                ...
                <ShadowCard className="p-6 border-l-4 border-l-orange-500 hover:shadow-xl transition-all duration-300">
                    <div className="flex justify-between items-start mb-4">
          ...
          {/* Sidebar Area: Deadlines and Status */}
        ...
        <ShadowCard className="p-20 flex flex-col items-center justify-center text-center bg-gray-50/10 border-dashed">
          <div className="p-8 bg-white shadow-sm rounded-full mb-8 text-gray-300 transform transition-transform hover:scale-110 duration-500">
            ...
            {activeTab === 'library' && <Library className="h-20 w-20" />}
