...
export default function ExtendedTBTable({ data, onUpdateRow, onDeleteRow }: ExtendedTBTableProps) {
                ...
                <table className="w-full text-sm">
                    <thead>
                        <tr className="bg-gray-50/50 border-b border-gray-200">
                            ...
                            <th className="py-4 px-4 font-semibold text-gray-600 min-w-[300px] text-center">Classification</th>
                            <th className="py-4 px-4 font-semibold text-gray-600 w-16 text-center">Actions</th>
                        </tr>
                    </thead>
