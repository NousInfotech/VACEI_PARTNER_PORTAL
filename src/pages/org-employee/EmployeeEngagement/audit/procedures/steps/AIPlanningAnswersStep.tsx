...
interface AIPlanningAnswersStepProps {
  engagement: any;
  mode: "ai" | "hybrid";
  stepData: any;
...
export const AIPlanningAnswersStep: React.FC<AIPlanningAnswersStepProps> = ({
  engagement,
  stepData,
  onComplete,
  onBack,
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-1">Generate planning answers (AI)</h3>
