...
interface ManualPlanningProceduresStepProps {
  engagement: any;
  mode: "manual" | "hybrid";
  stepData: any;
...
export const ManualPlanningProceduresStep: React.FC<ManualPlanningProceduresStepProps> = ({
  stepData,
  onComplete,
  onBack,
}) => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-1">Manual planning procedures</h3>
