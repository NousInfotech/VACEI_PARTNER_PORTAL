...
interface AIPlanningQuestionsStepProps {
  engagement: any;
  mode: "ai" | "hybrid";
  stepData: any;
...
export const AIPlanningQuestionsStep: React.FC<AIPlanningQuestionsStepProps> = ({
  engagement,
  stepData,
  onComplete,
  onBack,
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-1">Generate planning questions (AI)</h3>
