/**
 * Hybrid completion: manual content per section first, then "Generate AI" per section.
...
interface HybridCompletionProceduresStepProps {
  engagement: any;
  mode: "ai" | "hybrid";
  stepData: any;
...
export const HybridCompletionProceduresStep: React.FC<HybridCompletionProceduresStepProps> = ({
  engagement,
  stepData,
  onComplete,
  onBack,
