            ...
            <table className="w-full text-sm text-left">
                ...
                <tbody className="divide-y divide-gray-100">
                    {[
                        ...
                        <tr key={row.id} className={selectedItemId === row.id ? "bg-indigo-50/50" : "hover:bg-gray-50/50"}>
